...
encodings = {
        "fulltransitions_slf_labeleff": "full_transitions_sat(use_self_loop_optimisation=true, use_labels_in_effects_constraints=true)",
        "fulltransitions_slf_transeff": "full_transitions_sat(use_self_loop_optimisation=true, use_labels_in_effects_constraints=false)",
        "fulltransitions_____labeleff": "full_transitions_sat(use_self_loop_optimisation=false, use_labels_in_effects_constraints=true)",
		"fulltransitions_____transeff": "full_transitions_sat(use_self_loop_optimisation=false, use_labels_in_effects_constraints=false)",
		"splittransitions_slf_labeleff": "split_transitions_sat(use_self_loop_optimisation=true, use_labels_in_effects_constraints=true)",
		"splittransitions_slf_transeff": "split_transitions_sat(use_self_loop_optimisation=true, use_labels_in_effects_constraints=false)",
		"splittransitions_____labeleff": "split_transitions_sat(use_self_loop_optimisation=false, use_labels_in_effects_constraints=true)",
		"splittransitions_____transeff": "split_transitions_sat(use_self_loop_optimisation=false, use_labels_in_effects_constraints=false)",
...
TRANSFORM_OPTS = {
        #"-ntr" : ["--transform-task", "./builds/release64/bin/preprocess-h2", "--transform", "cost(cost_type=one)"],
        ...
        "-shr-Blr" : ["--transform-task", "./builds/release64/bin/preprocess-h2", "--transform", "transform_merge_and_shrink(shrink_strategy=shrink_weak_bisimulation(ignore_irrelevant_tau_groups=false),label_reduction=exact(max_time=300,atomic_fts=true,before_shrinking=true,before_merging=false,method=ONLY_EQUIVALENT_LABELS),shrink_atomic_fts=true,run_main_loop=false,max_time=900,cost_type=one,prune_transitions_from_goal=true,prune_transitions_from_goal=true)"],
