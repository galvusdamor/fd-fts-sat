...
REVISION = "bc5484e76dc9693a8a78a25fffe5f181f0f2913e"
REVISIONS = [REVISION]
...
searches = {
        ("CM-" + name) : "rintanen(encoder=" + encodings[name] + ", solver_quiet=true,length_strategy=by_iteration(),memory_limit_mb=3500,max_parallel_calls=20,scheduler_interval=1,schedule_formula_as_one=true)" for name in encodings
}
