...
REVISION = "134f49662efe668b1bc8582606555281291588ea"
REVISIONS = [REVISION]
...
searches = {
        ("C-" + name) : "rintanen(encoder=" + encodings[name] + ", solver_quiet=true,length_strategy=by_iteration(),memory_limit_mb=3500,max_parallel_calls=20,scheduler_interval=1)" for name in encodings
}
