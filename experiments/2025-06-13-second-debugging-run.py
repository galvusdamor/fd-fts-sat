...
REVISION = "d2307c390d80e790b1e8b6484c142245f6fb8c32"
REVISIONS = [REVISION]
...
searches = {#"blind" : "astar(blind(), cost_type=one)",
            ...
            "bdd-impl-comb-nocut": "sat(encoding=2,impltseitsin=true,combinebdds=true,cutbdds=false)",
            "bdd-impl-comb-cut": "sat(encoding=2,impltseitsin=true,combinebdds=true,cutbdds=true)",
            "bdd-biim-nocomb-nocut": "sat(encoding=2,impltseitsin=false,combinebdds=false,cutbdds=false)",
