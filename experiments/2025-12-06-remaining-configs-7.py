...
encodings = {
        #"seq___________rcpo_": "label_sat(encoding=SEQUENTIAL,use_self_loop_optimisation=false,use_label_group=false,use_empty_pillars=true,use_empty_rows=true,use_empty_cols=true,use_positive_one=true,use_ones_in_last_dimension=false,force_at_least_one_action=FORCE)",
        "seq________lg_rcpo_": "label_sat(encoding=SEQUENTIAL,use_self_loop_optimisation=false,use_label_group=true,use_empty_pillars=true,use_empty_rows=true,use_empty_cols=true,use_positive_one=true,use_ones_in_last_dimension=false,force_at_least_one_action=FORCE)",
        "seq________lg_rcpol": "label_sat(encoding=SEQUENTIAL,use_self_loop_optimisation=false,use_label_group=true,use_empty_pillars=true,use_empty_rows=true,use_empty_cols=true,use_positive_one=true,use_ones_in_last_dimension=true,force_at_least_one_action=FORCE)",
        "seq________lg_____l": "label_sat(encoding=SEQUENTIAL,use_self_loop_optimisation=false,use_label_group=true,use_empty_pillars=false,use_empty_rows=false,use_empty_cols=false,use_positive_one=false,use_ones_in_last_dimension=true,force_at_least_one_action=FORCE)",
