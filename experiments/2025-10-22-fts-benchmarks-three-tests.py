...
REVISION = "2097076449101f6ee389802e562c510bbadb3c27"
REVISIONS = [REVISION]

CONFIGS = []

encodings = {
		"chains_slf_lg_rcp": "label_sat(encoding=CHAINS_PARALLEL,use_self_loop_optimisation=true,use_label_group=true,use_empty_pillars=true,use_empty_rows=true,use_empty_cols=true,force_at_least_one_action=true)",
		...
		"seq_slf_lg_rcp": "label_sat(encoding=SEQUENTIAL,use_self_loop_optimisation=true,use_label_group=true,use_empty_pillars=true,use_empty_rows=true,use_empty_cols=true,force_at_least_one_action=true)",
...
exp.add_fetcher(name='fetch', filter=[filters.remove_revision], filter_algorithm = ["chains_slf_lg_rcp-onlyshrink","loopparallel_slf_lg_rcp-onlyshrink", "seq_slf_lg_rcp-onlyshrink"])
