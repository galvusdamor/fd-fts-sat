...
CONFIGS = []
searches = {
            "chains-basic-per-row": "sat(encoding=0,solver_quiet=true,label_order=label_order_linear)",
            "chains-elim-row-col": "sat(encoding=1,solver_quiet=true,label_order=label_order_linear)",
            "chains-elim-rnc-pairs": "sat(encoding=2,solver_quiet=true,label_order=label_order_linear)",
}
