...
encodings = {
        #"seq____slf____rcpo_": "label_sat(encoding=SEQUENTIAL,use_self_loop_optimisation=true,use_label_group=false,use_empty_pillars=true,use_empty_rows=true,use_empty_cols=true,use_positive_one=true,use_ones_in_last_dimension=false,force_at_least_one_action=FORCE)",
