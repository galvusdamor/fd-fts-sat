...
encodings = {
		...
		"chains_slf____r___l": "label_sat(encoding=CHAINS_PARALLEL,use_self_loop_optimisation=true,use_label_group=false,use_empty_pillars=false,use_empty_rows=true,use_empty_cols=false,use_positive_one=false,use_ones_in_last_dimension=true,force_at_least_one_action=FORCE)",
		"chains_slf____r__ol": "label_sat(encoding=CHAINS_PARALLEL,use_self_loop_optimisation=true,use_label_group=false,use_empty_pillars=false,use_empty_rows=true,use_empty_cols=false,use_positive_one=true,use_ones_in_last_dimension=true,force_at_least_one_action=FORCE)",
		"chains_slf_____c__l": "label_sat(encoding=CHAINS_PARALLEL,use_self_loop_optimisation=true,use_label_group=false,use_empty_pillars=false,use_empty_rows=false,use_empty_cols=true,use_positive_one=false,use_ones_in_last_dimension=true,force_at_least_one_action=FORCE)",
		"chains_slf_____c_ol": "label_sat(encoding=CHAINS_PARALLEL,use_self_loop_optimisation=true,use_label_group=false,use_empty_pillars=false,use_empty_rows=false,use_empty_cols=true,use_positive_one=true,use_ones_in_last_dimension=true,force_at_least_one_action=FORCE)",
		"chains_slf______p_l": "label_sat(encoding=CHAINS_PARALLEL,use_self_loop_optimisation=true,use_label_group=false,use_empty_pillars=true,use_empty_rows=false,use_empty_cols=false,use_positive_one=false,use_ones_in_last_dimension=true,force_at_least_one_action=FORCE)",
		"chains_slf______pol": "label_sat(encoding=CHAINS_PARALLEL,use_self_loop_optimisation=true,use_label_group=false,use_empty_pillars=true,use_empty_rows=false,use_empty_cols=false,use_positive_one=true,use_ones_in_last_dimension=true,force_at_least_one_action=FORCE)",
		"chains_slf____rcp_l": "label_sat(encoding=CHAINS_PARALLEL,use_self_loop_optimisation=true,use_label_group=false,use_empty_pillars=true,use_empty_rows=true,use_empty_cols=true,use_positive_one=false,use_ones_in_last_dimension=true,force_at_least_one_action=FORCE)",
...
for t_name, t_opt in TRANSFORM_OPTS.items():
    ...
    CONFIGS.append(IssueConfig(f'lama-first{t_name}', t_opt + [
"--evaluator", "hlm=lmcount(lm_factory=lm_rhw(reasonable_orders=true),transform=adapt_costs(one),pref=false)","--evaluator", "hff=ff(transform=adapt_costs(one))","--search", "lazy_greedy([hff,hlm],preferred=[hff,hlm],cost_type=one,reopen_closed=false)"], driver_options=DRIVER_OPTS, build_options=["-j24", "-s/gpfs/home2/behnkeg/software/kissat-p/build", "--custom-kissat"]))
