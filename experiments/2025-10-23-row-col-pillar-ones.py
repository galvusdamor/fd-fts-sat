...
REVISION = "dc6d2aba4da56e1ab70868b881e1c079f16b7d6c"
REVISIONS = [REVISION]

CONFIGS = []

encodings = {
		"chains_slf_lg_rcpo": "label_sat(encoding=CHAINS_PARALLEL,use_self_loop_optimisation=true,use_label_group=true,use_empty_pillars=true,use_empty_rows=true,use_empty_cols=true,use_positive_one=true,force_at_least_one_action=true)",
		"chains_slf_lg_rcp_": "label_sat(encoding=CHAINS_PARALLEL,use_self_loop_optimisation=true,use_label_group=true,use_empty_pillars=true,use_empty_rows=true,use_empty_cols=true,use_positive_one=false,force_at_least_one_action=true)",
		
        "chains_slf_lg_rc__": "label_sat(encoding=CHAINS_PARALLEL,use_self_loop_optimisation=true,use_label_group=true,use_empty_pillars=false,use_empty_rows=true,use_empty_cols=true,use_positive_one=false,force_at_least_one_action=true)",
		"chains_slf_lg_r_p_": "label_sat(encoding=CHAINS_PARALLEL,use_self_loop_optimisation=true,use_label_group=true,use_empty_pillars=true,use_empty_rows=true,use_empty_cols=false,use_positive_one=false,force_at_least_one_action=true)",
		"chains_slf_lg__cp_": "label_sat(encoding=CHAINS_PARALLEL,use_self_loop_optimisation=true,use_label_group=true,use_empty_pillars=true,use_empty_rows=false,use_empty_cols=true,use_positive_one=false,force_at_least_one_action=true)",
		
        "chains_slf_lg_r___": "label_sat(encoding=CHAINS_PARALLEL,use_self_loop_optimisation=true,use_label_group=true,use_empty_pillars=false,use_empty_rows=true,use_empty_cols=false,use_positive_one=false,force_at_least_one_action=true)",
        "chains_slf_lg__c__": "label_sat(encoding=CHAINS_PARALLEL,use_self_loop_optimisation=true,use_label_group=true,use_empty_pillars=false,use_empty_rows=false,use_empty_cols=true,use_positive_one=false,force_at_least_one_action=true)",
		"chains_slf_lg___p_": "label_sat(encoding=CHAINS_PARALLEL,use_self_loop_optimisation=true,use_label_group=true,use_empty_pillars=true,use_empty_rows=false,use_empty_cols=false,use_positive_one=false,force_at_least_one_action=true)",
		
        "chains_slf_lg_____": "label_sat(encoding=CHAINS_PARALLEL,use_self_loop_optimisation=true,use_label_group=true,use_empty_pillars=false,use_empty_rows=false,use_empty_cols=false,use_positive_one=false,force_at_least_one_action=true)",
		#"loopparallel_slf_lg_rcp": "label_sat(encoding=SELF_LOOP_PARALLEL,use_self_loop_optimisation=true,use_label_group=true,use_empty_pillars=true,use_empty_rows=true,use_empty_cols=true,force_at_least_one_action=true)",
		"seq_---_--_---": "label_sat(encoding=SEQUENTIAL,use_self_loop_optimisation=false,use_label_group=false,use_empty_pillars=false,use_empty_rows=false,use_empty_cols=false,force_at_least_one_action=true)",
        }

searches = {
        name : "sat(encoder=" + encodings[name] + ", solver_quiet=true,continue_after_first_plan=false,length_strategy=one_by_one())" for name in encodings
}
